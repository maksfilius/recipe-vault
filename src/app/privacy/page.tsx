...
export const metadata: Metadata = {
  ...
  description:
    "Read the Keep & Cook Privacy Policy to understand how account and recipe data is collected, used, and protected.",
};
...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-background px-6 py-16 text-foreground">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-border/75 bg-card/84 p-8 shadow-[0_24px_80px_hsl(var(--foreground)_/_0.08)] backdrop-blur md:p-12">
        <div className="mb-8 flex flex-col gap-3 border-b border-border/60 pb-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="inline-flex items-center rounded-full border border-border/75 bg-background/80 px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-foreground/5"
            >
              Back to home
            </Link>
            <Link
        ...
        <div className="space-y-10">
          <header className="space-y-4">
            ...
            <p className="max-w-3xl text-base leading-7 text-muted-foreground">
              This Privacy Policy explains what information Keep &amp; Cook collects, how we use
              it, and what choices you have when using the service.
            </p>
          </header>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <p>
                We also collect limited technical data needed to run and secure the service, such
                as session data, IP address, browser information, and basic server logs.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              We keep account and recipe data for as long as your account remains active, and for
              a limited period afterward when reasonably necessary for security, legal compliance,
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              If you use Keep &amp; Cook from outside the country where the service is operated,
              your information may be processed in other countries where our service providers
              operate.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Keep &amp; Cook is not intended for children, and we do not knowingly collect
              personal information from children under the age required by applicable law to use
              the service without parental consent.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            {env.supportEmail ? (
              ...
              <p className="text-muted-foreground">
                For privacy questions, set <code>NEXT_PUBLIC_SUPPORT_EMAIL</code> before launch so
                users have a working contact address.
              </p>
            )}
          </section>
